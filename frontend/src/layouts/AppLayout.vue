<template>
  <div class="flex h-screen overflow-hidden bg-slate-50">
    ...
    <div class="flex flex-1 flex-col overflow-hidden">
      <!-- Top bar -->
      <header
        class="flex h-16 shrink-0 items-center justify-between border-b border-slate-100 bg-white px-6"
      >
        <!-- Breadcrumb -->
        ...
        <div class="flex items-center gap-4">
          ...
          <button
            class="relative rounded-xl p-1.5 text-slate-400 hover:bg-slate-50 hover:text-slate-600 transition"
          >
            <svg
              class="h-5 w-5"
              fill="none"
          ...
          <div class="flex items-center gap-2">
            <div
              class="flex h-7 w-7 items-center justify-center rounded-full bg-slate-200 text-[11px] font-semibold text-slate-600"
            >
              {{ userInitial }}
            </div>
