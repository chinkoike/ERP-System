        ...
        <tbody>
          ...
          <template v-if="isInitialLoading">
            <tr v-for="n in 5" :key="`order-skeleton-${n}`" class="border-b border-slate-100">
              ...
              <td class="px-6 py-4">
                <div class="h-3 bg-slate-100 rounded-md w-40 animate-pulse"></div>
              </td>
              <td class="px-6 py-4">
                <div class="h-3 bg-slate-200 rounded-md w-24 animate-pulse"></div>
              </td>
              <td class="px-6 py-4">
                <div class="h-3 bg-slate-200 rounded-md w-8 mx-auto animate-pulse"></div>
              </td>
              <td class="px-6 py-4">
                <div class="h-3 bg-slate-200 rounded-md w-20 ml-auto animate-pulse"></div>
              </td>
              <td class="px-6 py-4">
                <div class="h-6 bg-slate-200 rounded-full w-20 mx-auto animate-pulse"></div>
              </td>
              <td class="px-6 py-4">
